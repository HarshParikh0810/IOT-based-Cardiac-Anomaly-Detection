...
This project implements a real-time IoT-enabled cardiac monitoring system capable of measuring ECG signals, heart rate (BPM), and oxygen saturation (SpO₂). Data is acquired using **ESP32 + AD8232 + MAX30102**, processed by a **FastAPI backend**, visualized on a **Streamlit dashboard**, and analyzed using an **ML model** trained on the **UCI Cleveland Heart Disease Dataset** to predict cardiac anomalies.
...
| **Jumper wires & ECG electrodes** | Connections and body contact |
...
│   └── xgboost_cleveland_model.pkl  # Trained model
│
├── dashboard/
...
| **Features Used** | Age, Gender, Heart Rate, SpO₂, ECG-derived metrics |
| **Output** | Probability of anomaly, Binary classification (0 = Normal, 1 = Anomaly) |
